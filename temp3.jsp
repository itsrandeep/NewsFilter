...
for(int re=0;re<f;re++){
    ...
    json+=((char)i);
        ...
        String sortBy = (String) jsonObject.get("status");
   ...
   <br>
     <%
       ...
       description[rec]= (String)array[k].get("description") ;
        ...
        out.print("<div class=\"panel panel-default\"><br> <div class=\"panel-heading\">"+title[rec]+"</div><br><div class=\"panel-content\"><a href=\""+surl[rec]+"\" target=\"_blank\"><img src=\""+imageUrl[rec]+"\" height='100' width='100'><br>"+description[rec]+"</a></div></div>");
        rec++;
 %>
